...
class Classify(op_base):
    ...
    def attack_graph(self,lr = 0.1,momentum = 0.5):
        ...
        def cell_graph(logit,need_label_cross = True,need_target_cross = False):
            ...
            if(need_label_cross):
                ...
                r_restel_lab_base = tf.cond( label_cross_entropy_resnet_tel < -100.,lambda: 0.,lambda: 1.)
    ...
    def writer(self,_image_path,write_image):
        ...
        image_combine_with_noise = os.path.join('data','test_result','test_no_tar',_image_path)
