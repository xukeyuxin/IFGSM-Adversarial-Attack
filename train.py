    ...
    def attack(self):
        ...
        for _ in tqdm(range(100)):
            ...
            for i in range(0,501):
                ...
                _,write_image,_weight,_loss,_t_loss = self.sess.run([train_op,self.combine_images,self.loss_weight,self.total_loss,self.target_cross_entropy_resnet_tel],feed_dict = feed_dict)
                print(_loss)
                print(_t_loss)
                # if( _loss <= -120.):
